...
class _BackupScreenState extends State<BackupScreen> {
  ...
  Future<void> _confirmImport() async {
    ...
    if (confirm == true && mounted) _run(() => _backup.importFullBackup());
  }
      ...
      builder: (_) => AlertDialog(
        ...
        actions: [
          ...
          ElevatedButton(
            ...
            onPressed: () => Navigator.pop(context, true),
            child: const Text('اختر الملف', style: TextStyle(fontFamily: 'Cairo', fontWeight: FontWeight.w700)),
          ),
        ],
      ),
    );
    if (confirm == true && mounted) _run(() => _backup.importProductsFromExcel());
  }
}
